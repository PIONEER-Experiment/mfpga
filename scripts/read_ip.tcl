...
if {[file exists $ROOT/ip/axis_switch_rx/axis_switch_rx.xci
	...
	set_property -dict [list CONFIG.NUM_SI {2} CONFIG.NUM_MI {1} CONFIG.TDATA_NUM_BYTES {4} CONFIG.HAS_TLAST {1} CONFIG.ARB_ON_MAX_XFERS {1024} CONFIG.ARB_ON_NUM_CYCLES {1} CONFIG.ARB_ALGORITHM {1}] [get_ips axis_switch_rx]
