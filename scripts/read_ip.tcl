...
if {[file exists $ROOT/ip/chan_link_axis_data_fifo/chan_link_axis_data_fifo.xci
	...
	set_property -dict [list CONFIG.TDATA_NUM_BYTES {2} CONFIG.FIFO_DEPTH {4096} CONFIG.IS_ACLK_ASYNC {1} CONFIG.HAS_TKEEP {1} CONFIG.HAS_TLAST {1}] [get_ips chan_link_axis_data_fifo]
...
if {[file exists $ROOT/ip/aurora_8b10b_0/aurora_8b10b_0.xci]} {
	...
	set_property -dict [list CONFIG.C_LINE_RATE {5.0} CONFIG.C_GT_LOC_1 {X} CONFIG.C_GT_LOC_5 {1}] [get_ips aurora_8b10b_0]
