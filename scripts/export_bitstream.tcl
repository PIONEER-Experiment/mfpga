...
if {[file exists ./wfd_top.bit]} {
  file copy -force ./wfd_top.bit [file dirname [info script]]/../bitstreams/wfd_golden_$version.bit
  puts "INFO: Bitstream copied: wfd_golden.bit"
  write_cfgmem -force -format MCS -size 32 -interface SPIx1 \
      -loadbit "up 0x0 ./wfd_top.bit" [file dirname [info script]]/../bitstreams/wfd_golden_$version
} else {
