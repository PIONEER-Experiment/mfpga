...
foreach file [glob $origin_dir/ip/standard_mode_only/*/*.xci] {        #*/
...
foreach file [glob $origin_dir/ip/common/*/*.xci] {          #*/
    set file [file normalize $file]
  set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
  if { ![get_property "is_locked" $file_obj] } {
      set_property "synth_checkpoint_mode" "Singular" $file_obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7k160tfbg676-1 -flow {Vivado Implementation 2025} -strategy "Performance_Explore" -constrset constrs_impl_1 -parent_run synth_1
} else {
