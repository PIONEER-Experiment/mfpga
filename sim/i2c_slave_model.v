...
module i2c_slave_model (WP, SDA, SCL, RESET);
...
// *******************************************************************************************************
   ...
   integer              k;  		                    // iterative loop index
...
// *******************************************************************************************************
   ...
   initial begin
	...
	initial begin
	   // initialize the whole memory to zero
	   for (k = 0; k < 255; k = k + 1) begin
	   	MemoryBlock[k] = 8'h00;
	   end
	   // now set special values in a few locations
	   MemoryBlock[0] = 8'h55;
	   MemoryBlock[1] = 8'h44;
	   MemoryBlock[2] = 8'h33;
	   MemoryBlock[3] = 8'h22;
	   MemoryBlock[128] = 8'h99;
	   MemoryBlock[129] = 8'h88;
	   MemoryBlock[130] = 8'h77;
	   MemoryBlock[131] = 8'h66;
	end
