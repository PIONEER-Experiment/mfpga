These files are here for reference. They are state machines Robin and David built using Fizzim.
They have since been re-done in the Master FPGA firmware (without Fizzim) so that the code is
