...
set_false_path -from [get_cells command_manager/chan_burst_count_reg*] -to [get_cells command_manager/daq_data_reg*]
set_false_path -from [get_cells command_manager/chan_wfm_count_reg*]   -to [get_cells command_manager/daq_data_reg*]
