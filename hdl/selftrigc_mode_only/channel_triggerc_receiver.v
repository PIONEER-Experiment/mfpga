...
module channel_triggerc_receiver (
  // clock and reset
...
//st  assign amc13_payload_full = ((104857 - stored_bursts_chan0[22:0]) < chan_en*(burst_count_chan0[22:0] + 1));
  ...
  always @* begin
    ...
    next_selftriggers    = selftriggers;
    ...
    case (1'b1) // synopsys parallel_case full_case
      ...
      state[IDLE] : begin
        if (trigger & chan_en) begin
          ...
          next_selftriggers = selftriggers + 1;
  ...
  always @(posedge clk) begin
    ...
    // defaults
    selftriggers = next_selftriggers;
    ...
    if ( reset | new_fill ) begin
      ...
      stored_bursts[22:0] <= stored_bursts[22:0] + (burst_count_selftrig[22:0] + 1);
    end
  end
